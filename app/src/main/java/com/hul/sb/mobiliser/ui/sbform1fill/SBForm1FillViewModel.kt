...
class SBForm1FillViewModel @Inject constructor(
    ...
    var noOfMembers = MutableLiveData<String>("")
    var isThereToilet = MutableLiveData<String>("")
    var isThereWaching = MutableLiveData<String>("")
    var visitedSuvidha = MutableLiveData<String>("")
    ...
    init {
        ...
        loginEnabled.addSource(imageUrl1) {
            loginEnabled.value = it.length > 0 &&
                    ...
                    imageUrl5.value!!.length > 0 &&
                    houseCode.value!!.length > 0 &&
                    customerName.value!!.length > 0  &&
                    noOfMembers.value!!.length > 0 &&
                    isThereToilet.value!!.length > 0 &&
                    isThereWaching.value!!.length > 0 &&
                    visitedSuvidha.value!!.length > 0 &&
        ...
        loginEnabled.addSource(noOfMembers) {
            loginEnabled.value = it.length > 0 &&
                    imageUrl1.value!!.length > 0 &&
                    imageUrl2.value!!.length > 0 &&
                    imageUrl3.value!!.length > 0 &&
        ...
        loginEnabled.addSource(isThereToilet) {
            loginEnabled.value = it.length > 0 &&
                    imageUrl1.value!!.length > 0 &&
                    imageUrl2.value!!.length > 0 &&
                    imageUrl3.value!!.length > 0 &&
        ...
        loginEnabled.addSource(isThereWaching) {
            loginEnabled.value = it.length > 0 &&
                    imageUrl1.value!!.length > 0 &&
                    imageUrl2.value!!.length > 0 &&
                    imageUrl3.value!!.length > 0 &&
        ...
        loginEnabled.addSource(visitedSuvidha) {
            loginEnabled.value = it.length > 0 &&
                    imageUrl1.value!!.length > 0 &&
                    imageUrl2.value!!.length > 0 &&
                    imageUrl3.value!!.length > 0 &&
        ...
        loginEnabled.addSource(address) {
            loginEnabled.value = it.length > 0 &&
                    imageUrl1.value!!.length > 0 &&
                    imageUrl2.value!!.length > 0 &&
                    imageUrl3.value!!.length > 0 &&
        ...
        loginEnabled.addSource(mobile) {
            loginEnabled.value = it.length == 10 &&
                    imageUrl1.value!!.length > 0 &&
                    imageUrl2.value!!.length > 0 &&
                    imageUrl3.value!!.length > 0 &&
                    imageUrl4.value!!.length > 0 &&
    ...
    var noOfMembersError : LiveData<String> = noOfMembers.map {
    ...
    var isThereToiletError : LiveData<String> = isThereToilet.map {
    ...
    var isThereWachingError : LiveData<String> = isThereWaching.map {
    ...
    var visitedSuvidhaError : LiveData<String> = visitedSuvidha.map {
